    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 notice_section_right">
                    <div class="notice_section">
                        <div class="notice_section_title">
                            <h2>Recent News</h2>
                            <span></span>
                        </div>
                        <div class="notice_section_button">
                            <a href="#">View All</a>
                        </div>
                    </div>
...
.card_main:nth-child(4) .card_date {
    background-color: #31AED3;
}

.card_main:nth-child(5) .card_date {
    background-color: #31AED3;
}
...
.notice_section_left .nav-pills .nav-link.active {
    background-color: white;
    color: #872683;
    border-bottom: 4px solid #872683;
    border-radius: 0px;
    text-align: left;
    font-family: 'Rubik';
    font-style: normal;
...
.notice_section_title span {
    height: 4px;
    display: block;
    height: 4px;
    background-color: #086B30;
}

.notice_section_button {
    float: right;
}

.notice_section_button a {
    border: 2px solid #086B30;
    font-family: 'Rubik';
    font-style: normal;
    font-weight: normal;
    font-size: 14px;
...
.notice_section_card {
    ...
    overflow: hidden;
    margin: 10px 0px;
    background-image: url('./../../assets/images/recent_news.png');
...
.notice_card_title {
    background: linear-gradient(180deg, #086B30 0%, rgba(8, 107, 48, 0.65) 0.01%, rgba(8, 107, 48, 0.76) 100%);
    position: absolute;
    bottom: 0px;
    left: 0px;
    right: 0px;
